...
import (
	...
	"github.com/jmprusi/kcp-ingress/pkg/client/clientset/versioned/scheme"
...
// NetworkingV1alpha1Client is used to interact with features provided by the networking.kcp-ingress.dev group.
type NetworkingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NetworkingV1alpha1Client) GlobalLoadBalancers(namespace string) GlobalLoadBalancerInterface {
