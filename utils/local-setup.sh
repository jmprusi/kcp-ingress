...
${KCP_BIN} start --push_mode --install_cluster_controller --resources_to_sync=deployments --resources_to_sync=services --resources_to_sync=ingresses.networking.k8s.io --auto_publish_apis > ${KCP_LOG_FILE} 2>&1 &
KCP_PID=$!
